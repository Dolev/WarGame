...
//dolev's Tests
            board.move(2, {7,5}, Board::MoveDIR::Right);    // FootCommander of player 2 moves right from {7,5} to {7,6}, and all soldiers of player 2 attack.
            if (!board.has_soldiers(1)) return 2;
            ...
            board.move(2, {7,7}, Board::MoveDIR::Left);    // FootCommander of player 2 moves left from {7,7} to {7,6}, and all soldiers of player 2 attack.
            if (!board.has_soldiers(1)) return 2;

            board.move(1, {0,5}, Board::MoveDIR::Up);      // FootCommander of player 1 moves forward from {0,5} to {1,5}, and all soldiers of player 1 attack.
            if (!board.has_soldiers(2)) return 1;

            board.move(1, {0,7}, Board::MoveDIR::Up);      // FootCommander of player 1 moves forward from {0,7 to {1,7}, and all soldiers of player 1 attack.
            if (!board.has_soldiers(2)) return 1;
